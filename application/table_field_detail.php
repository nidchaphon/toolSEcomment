...
$field_list = $detail_list->getDetailColumnList($db,$tbName,$listby);
        ...
        <div class="panel panel-default">
            <div class="panel-heading" style="font-size: 24px; text-align: center; font-weight: bold">
                <div class="row">
                    ...
                    <div class="col-md-9"><span style="font-size: 25px;">รายการฟิลด์ในตาราง <?php echo $tbName; ?></span>
                        ...
                        <tr class="odd gradeX">
                            ...
                            <td style="vertical-align: middle;">
                                <div class="row">
                                    ...
                                    <div class="col-md-1"><a href="table_field_detail.php?db_name=<?php echo $val['db_name']; ?>&tb_name=<?php echo $val['tb_name']; ?>"><i class="fa fa-reply" title="เลือกคอมเม้นนี้"></i></a></div>
                                </div>
                            </td>
                        </tr>
                    <?php } ?>
